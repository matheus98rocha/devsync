...
const Feed = ({ posts, myUserId }: FeedProps) => {
  ...
  const [showSuccessfulNewPostAlert, setShowSuccessfulNewPostAlert] =
    React.useState<boolean>(false);
  const [showSuccessfulDeletedPostAlert, setSuccessfulDeletedPostAlert] =
    React.useState<boolean>(false);
  const [showDeletePostModal, setShowDeletePostModal] =
    React.useState<boolean>(false);
  const [isLoadingDeletePost, setIsLoadingDeletePost] =
    React.useState<boolean>(false);
